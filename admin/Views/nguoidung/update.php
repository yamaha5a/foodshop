...
<head>
    ...
    <link rel="stylesheet" href="css.css"> <!-- File CSS từ dự án -->
...
<div class="table-card">
    ...
    <form action="index.php?act=updateNguoiDung" method="POST" enctype="multipart/form-data" class="data-table">
        ...
        <div class="form-group">
            ...
            <div>
                <label><input type="radio" name="gioitinh" value="Nam" <?php echo ($nguoiDung['gioitinh'] == 'Nam') ? 'checked' : ''; ?>> Nam</label>
                <label><input type="radio" name="gioitinh" value="Nữ" <?php echo ($nguoiDung['gioitinh'] == 'Nữ') ? 'checked' : ''; ?>> Nữ</label>
                <label><input type="radio" name="gioitinh" value="Khác" <?php echo ($nguoiDung['gioitinh'] == 'Khác') ? 'checked' : ''; ?>> Khác</label>
            </div>
        </div>

        <div class="form-group">
            <label for="matkhau">Mật khẩu mới:</label>
            <input type="password" id="matkhau" name="matkhau" placeholder="Nhập mật khẩu mới (nếu có)">
        </div>
